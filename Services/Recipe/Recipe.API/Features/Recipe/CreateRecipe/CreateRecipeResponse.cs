namespace Recipe.API.Features.Recipe.CreateRecipe
{
    ...
    public record CreateRecipeResponse(int Id, int UserId, string Title, string Description, int PrepTimeMinutes, int CookTimeMinutes, 
        ...
        List<ResponseIngredient> Ingredients, List<ResponseStep> Steps, List<ResponseTag> Tags); 
}
